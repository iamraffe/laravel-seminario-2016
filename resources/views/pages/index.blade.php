...
@section('description')
El propósito del seminario es ofrecer a los asistentes la voz de unos ponentes de alta relevancia que difícilmente coincidirían en un acto debido a sus agendas
@stop
...
@section('content')
    ...
    <div class="row letter">
      <div class="container">
        <div class="row">
          <div class="col-md-7 col-md-offset-1 letter-intro">
            <h2>Jueves, 5 de mayo de 2016</h2><h2>Hospital Universitario Fundación Jiménez Díaz (Madrid-España)</h2>
            <hr>
          </div>
        </div>
        <div class="row">
          <div class="col-md-10 col-md-offset-1 letter-content">
            <h3 class="letter-salutation bold">Estimados profesionales del sector sanitario:</h3>
            <p>Presentamos el programa del 3<sup>er</sup>. Seminario Internacional de Seguridad del Paciente y Excelencia Clínica, continuando con la iniciativa que comenzamos en 2014 y que tiene como objetivo principal ofrecer a los asistentes presentaciones de profesionales líderes en el desarrollo de ideas, estrategias y programas de  mejora de la calidad y seguridad del paciente.</p>
